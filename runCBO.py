...
parser.add_argument('--model_type', default = 0 , type = int, help = 'multi task or single task')
...
if experiment == 'PSAGraph':
    graph = PSAGraph(observational_samples)
...
global_opt, observed, total_time) = CBO(num_trials, eval(exploration_set), manipulative_variables, data_x_list, data_y_list,  BF_data, PF_data,
													...
													num_interventions, Causal_prior = causal_prior, model_type = model_type)
